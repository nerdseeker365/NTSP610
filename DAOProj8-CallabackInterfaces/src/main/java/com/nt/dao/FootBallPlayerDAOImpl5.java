...
public class FootBallPlayerDAOImpl5 implements FootBallPlayerDAO {
	...
	public FootBallPlayerDAOImpl5(JdbcTemplate jt) {
		this.jt = jt;
	}
	...
	public List<FootBallPlayerBO> findPlayersByRole(String role) {
		...
		listBO=jt.query(GET_PLAYERS_BY_ROLE, this::extractData,role);
		return listBO;
		
	}
	
	
	public  List<FootBallPlayerBO> extractData(ResultSet rs)throws SQLException{
		System.out.println("FootBallPlayerDAOImpl5.extractData(-,-)");
		List<FootBallPlayerBO> listBO=null;
